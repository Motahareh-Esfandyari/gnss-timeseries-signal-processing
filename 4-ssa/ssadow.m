...
%  ------------------------------------------------------------------------
%  Function: ssadow.m
%  Purpose : SSA smoothing/reconstruction following Golyandina et al.
%            (2001). Used for comparison with my own SSA.m.
%  ------------------------------------------------------------------------
%  Used by                 : Motahareh Esfandyari-Kaloukan
%  Original implementation : F.J. Alonso Sanchez, University of
%                            Extremadura, Spain (see credit below)
%  ========================================================================

function [y,r,vr]=ssadow(x1,L)
